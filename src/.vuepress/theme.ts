...
export default hopeTheme({
  ...
  // author: {
  //   name: "Ershi",
  //   url: "https://github.com/ErshiCode",
  // },
  ...
  blog: {
    ...
    medias: {
      GitHub: "https://github.com/ErshiCode",
  ...
  locales: {
    "/": {
      footer: `
        Copyright © 2025 ErshiCode | 
        <a href="https://beian.miit.gov.cn/" target="_blank">黑ICP备2025039986号-1</a>
      `,
